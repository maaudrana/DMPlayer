...
import com.loitp.LApplication;
import com.loitp.R;
import com.loitp.activities.DMPlayerBaseActivity;
import com.loitp.models.SongDetail;
import com.loitp.phonemidea.DMPlayerUtility;
...
public class MusicPlayerService extends Service implements AudioManager.OnAudioFocusChangeListener, NotificationManager.NotificationCenterDelegate {
    ...
    private void createNotification(SongDetail mSongDetail) {
        try {
            ...
            Intent intent = new Intent(LApplication.applicationContext, DMPlayerBaseActivity.class);
            intent.setAction("openplayer");
            intent.setFlags(32768);
            PendingIntent contentIntent = PendingIntent.getActivity(LApplication.applicationContext, 0, intent, 0);
            ...
            Bitmap albumArt = audioInfo != null ? audioInfo.getSmallCover(LApplication.applicationContext) : null;
...
//                notification.bigContentView.setTextViewText(R.id.player_albumname, albumName);
            ...
            if (remoteControlClient != null) {
                ...
                if (audioInfo != null && audioInfo.getCover(LApplication.applicationContext) != null) {
                    metadataEditor.putBitmap(RemoteControlClient.MetadataEditor.BITMAP_KEY_ARTWORK,
                            audioInfo.getCover(LApplication.applicationContext));
                }
